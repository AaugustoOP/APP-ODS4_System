    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-blue-950 to-slate-900 flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        >
          ...
          <p className="text-blue-300">Crie sua conta e comece a estudar</p>
        </motion.div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <p className="text-blue-300 text-sm">
                  Transforme seus estudos com gamificação
                </p>
              </div>
              ...
              <div className="space-y-4">
                <div>
                  <label className="text-sm text-blue-300 mb-2 block">Nome Completo</label>
                ...
                <div>
                  <label className="text-sm text-blue-300 mb-2 block">Confirmar Senha</label>
                  <div className="relative">
                    <Lock className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-blue-400" />
                    <Input
                      type="password"
              ...
              <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-4 space-y-2">
                <p className="text-blue-300 text-sm font-medium mb-2">Ao criar sua conta, você terá:</p>
